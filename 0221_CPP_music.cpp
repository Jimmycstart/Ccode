...
void Summer()
{
	...
	int summer[] = {
		...
		H1,_,M5,M1,H1,H2,M3,_,H5,_,H1,H2,_,H3,_,H1,H2,_,H3,_,H1,_,M5,M1,H1,H2,M3,_,H5,_,H2,H2,_,H3,_,H2,H3,_,H3,_,H3,H2,H1,_,H1,M5,M6,M3,M5,_,H3,H2,H1,_,H1,M5,M6,M3,M5,_,H3,H2,H2,_,H2,H1,M7,_,M6,M7,M5,M6,_,_,M6,M5,M6,_,M5,H1,H2,H5,M5,H1,H2,M5,H5,_,M5,H1,H2,M5,H5,M5,H1,M5,H2,M5,H5,_,M5,H1,H2,H5,M5,H1,H2,M5,H5,_,M5,H1,H2,H5,M5,H1,M5,H2,M5,H5,_,
		H1,_,M5,M1,H1,H2,M5,H3,_,H5,M5,H2,H2,_,H3,_,H1,H2,_,H3,_,H1,_,M5,M1,H1,H2,M5,H3,_,H5,_,H2,H2,_,H3,_,H2,M3,_,H3,_,H3,H2,M3,H1,_,H1,M5,M6,M3,M5,_,H3,H2,M3,H1,_,H1,_,H1,M5,M6,M3,M5,_,H3,H2,H2,_,H2,H1,M7,_,M6,M7,M5,M6,_,_,_,
	};
	for (auto i : summer)
	{
...
void Piano()
{
	...
	midiOutOpen(&handle, 0, 0, 0, CALLBACK_NULL);
	std::map<char, int>v = {
		{'Z',C3},{'X',D3},{'C',E3},{'V',F3},{'B',G3},{'N',A3},{'M',B3},{'A',C4},{'S',D4},{'D',E4},{'F',F4},{'G',G4},{'H',A4},{'J',B4},{'Q',C5},{'W',D5},{'E',E5},{'R',F5},{'T',G5},{'Y',A5},{'U',B5}
	};
	printf("¸ÖÇÙÒÑ¿ªÆô£¬ÇÃ»÷¼üÅÌQ-U,A-J,Z-M\n");
	while (1)
	{
		for (char i = 'A'; i <= 'Z'; i++)
		{
